...
CREATE PROCEDURE submit_ad(
  ...
  BEGIN
    INSERT INTO tbl_adverts(title, item_condition, description, price, negotiable, created_date, slug, status, flag, user_id, location_id, category_id, token) 
    VALUES(title, itemcondition, descrip, price, negotiable, CURRENT_TIMESTAMP(), slug, 0, 0, usid, location_id, category_id, token);
