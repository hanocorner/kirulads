CREATE VIEW admin_ad AS
SELECT t1.adid, t1.title, t1.item_condition, t1.status, t1.description, t1.negotiable, DATE_FORMAT(t1.created_date, "%M %e, %Y") AS date, t1.price, t1.slug, t2.main_image, t2.sub_images, t2.path_string, t3.name AS subcategory, t4.name AS category, t5.name AS sublocation, t6.name AS location, t7.fullname, t7.phone_number, t7.email
