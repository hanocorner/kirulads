...
SELECT t1.adid, t1.title, DATE_FORMAT(t1.created_date, "%M %e, %Y") AS date, t1.price, t1.slug, t2.main_image, t2.path_string, 
t3.name AS subcategory, t4.name AS category, t3.slug AS cat_slug,
t5.name AS sublocation, t6.name AS location, t5.slug AS loc_slug 
