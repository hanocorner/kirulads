<div class="container flex-length mt-5">
	...
	<div class="card post-ad-card">
		<div class="card-body">
			...
			<h5 class="mb-2 mt-5">Add Photos</h5>
			...
			<div class="ad-image">
				...
				<div class="image">
					<img src="<?php echo base_url('assets/images/noimage.png'); ?>" class="img-fluid" alt="" id="imageAd">
				</div>
			...
			<?php $attr = array('id'=>'formSubmitAdDetail', 'class'=>'mt-4', 'method'=>'post'); ?>
