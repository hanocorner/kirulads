...
class Category extends Admin_Controller
{
    ...
    public function index()
    {
        ...
        $this->layout->assets(base_url('assets/admin/js/category.js'), 'footer');
        $this->layout->view('admin/category/index');
    }
    ...
    public function populate_parent()
    {
        ...
        $this->load->model('admin/Category_model', 'catmodel');
        $results = $this->catmodel->populate_parent_category(); 
    ...
    public function populate_table()
    {
        ...
        $this->_data['results'] =  $this->catmodel->populate_table_data($rows_per_page, $start);
        $total_rows = $this->catmodel->_result_count;

        $this->_data['links'] = $this->html_pagination($rows_per_page, $total_rows);

        $this->load->view('admin/category/data_table', $this->_data);
    }
    ...
    public function add()
    {
        ...
        if(!$this->catmodel->add_data($this->_data))
        {
